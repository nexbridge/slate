...
5. This CLI will either be [TPS](https://en.wikipedia.org/wiki/Telephone_Preference_Service) screened or will not be used to make unsolicited sales/marketing calls within the UK.
6. This CLI will not be used to make unsolicited sales/marketing calls into the UK.
...
8. The end user is either based in the country corresponding to this CLI or, if not, this CLI will not be used to dial any destinations within the UK.
